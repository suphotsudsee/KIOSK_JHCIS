...
import { _ as _export_sfc, b as useRouter, u as useState } from './server.mjs';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/cid.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Cid = _sfc_main$1;
  _push(`<!--[-->`);
  ...
  _push(ssrRenderComponent(_component_Cid, null, null, _parent));
  _push(`<!--]-->`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/search_person.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const search_person = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { search_person as default };
//# sourceMappingURL=search_person-381712bb.mjs.map
